...
landmark_string = "\n".join(["{v}: {k}".format(v=landmark_choices[key], k=key) for key in landmark_choices.keys()])
stations_under_construction = ['Aberdeen', 'Lansdowne']
...
def new_route(start_point=None, end_point=None) :
    ...
    if shortest_route is not None : #not so sure about this bit
